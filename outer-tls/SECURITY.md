...
5. The provider counts encrypted records per write key and refuses records
   after 23,680,450. Decryption is not counted. libssl owns key/nonce
   uniqueness, directions, epochs, KeyUpdate, and connection termination.
