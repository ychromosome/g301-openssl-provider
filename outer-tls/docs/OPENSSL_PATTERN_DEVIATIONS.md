...
| Per-suite usage-limit metadata | Omitted | Provider enforces 23,680,450 encrypted records per uninterrupted key installation; supported libssl uses one installation per write-key epoch |
